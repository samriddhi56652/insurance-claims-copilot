...
def get_claim_requirements_repository() -> ClaimRequirementsRepository:
    return ClaimRequirementsRepository()


def get_claim_correspondence_repository() -> ClaimCorrespondenceRepository:
    return ClaimCorrespondenceRepository()
